...
A = [4.0, 2.0, 0.3, 0.8;  // Antiga R3
     0.6, 3.2, 1.8, 0.4;  // Antiga R4
     0.1, 0.2, 1.0, 0.3;  // Antiga R1
     0.3, 0.9, 0.3, 2.0]; // Antiga R2
     
B = [8.0; 15.0; 7.0; 8.0]; // Vetor B rearranjado na mesma ordem
